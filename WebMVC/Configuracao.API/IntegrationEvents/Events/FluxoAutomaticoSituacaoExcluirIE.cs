...
namespace Configuracao.API.IntegrationEvents.Events
{
    ...
    public class FluxoAutomaticoSituacaoExcluirIE : IntegrationEvent
    {
        ...
        public FluxoAutomaticoSituacaoExcluirIE(int tipoSituacaoAcomodacaoOrigemId, int tipoSituacaoAcomodacaoDestinoId, int tipoAtividadeAcomodacaoDestinoId, int empresaId)
        {
