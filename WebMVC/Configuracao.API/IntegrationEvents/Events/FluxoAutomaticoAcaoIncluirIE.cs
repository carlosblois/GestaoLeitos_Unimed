...
namespace Configuracao.API.IntegrationEvents.Events
{
    ...
    public class FluxoAutomaticoAcaoIncluirIE: IntegrationEvent
    {
        ...
        public FluxoAutomaticoAcaoIncluirIE(int tipoSituacaoAcomodacaoOrigemId, int tipoAtividadeAcomodacaoOrigemId, int tipoAcaoAcomodacaoOrigemId, int tipoSituacaoAcomodacaoDestinoId, int tipoAtividadeAcomodacaoDestinoId, int idEmpresa)
        {
