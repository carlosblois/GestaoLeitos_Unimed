...
using global::Produto.API.Infrastructure.Filters;
using global::Produto.API.IntegrationEvents;
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            services.Configure<ProdutoSettings>(configuration);
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Arquitetura - Produto HTTP API",
                    Version = "v1",
        ...
        public static IServiceCollection AddIntegrationServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            if (configuration.GetValue<bool>("AzureServiceBusEnabled"))
            {
                ...
                {
                    var settings = sp.GetRequiredService<IOptions<ProdutoSettings>>().Value;
