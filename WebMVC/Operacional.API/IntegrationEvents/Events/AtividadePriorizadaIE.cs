...
namespace Operacional.API.IntegrationEvents.Events
{
    ...
    public class AtividadePriorizadaIE : IntegrationEvent
    {
        ...
        public ConsultarAcomodacaoDetalhePorIdAcomodacaoTO DetAcomodacao { get; set; }

        public AtividadePriorizadaIE(int atividadeAcomodacaoId, int situacaoAcomodacaoId, int tipoSituacaoAcomodacaoId,
            ...
            ConsultarAcomodacaoDetalhePorIdAcomodacaoTO detAcomodacao)
        {
