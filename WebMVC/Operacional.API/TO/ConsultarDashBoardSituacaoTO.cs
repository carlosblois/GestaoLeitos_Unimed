...
{
    public class ConsultarDashBoardSituacaoTO
    {
        string m_sql;
        ...
        public ConsultarDashBoardSituacaoTO()
        {
        ...
        #region SQL
        public void ConsultarDashBoardSituacaoTOCommand(int IdEmpresa,int IdTipoSituacaoAcomodacao, string connection, ref List<ConsultarDashBoardSituacaoTO> l_ListTO)
        {


            m_sql = "  SELECT * ";
            m_sql += " FROM  [vw_ConsultarDashBoardSituacao] ";
