...
namespace Administrativo.API.IntegrationEvents.Events
{
    ...
    public class TipoAcomodacaoAtualizarIntegrationEvent : IntegrationEvent
    {
        ...
        public TipoAcomodacaoAtualizarIntegrationEvent(int empresaId, int tipoacomodacaoId, string tipoacomodacaoNome, string tipoAcomodacaoCodExterno, int tipoAcomodacaoIdCaracteristica)
        {
            EmpresaId = empresaId;
