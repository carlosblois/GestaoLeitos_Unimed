...
{
    public class ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoTO
    {
        string m_sql;
        ...
        public  ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoTO()
        {      
        ...
        #region SQL
        public void ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoTOCommand(int IdAcomodacao, string connection, ref List<ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoTO> l_ListAcomodacaoTO)
        {

            m_sql = " SELECT * ";
            m_sql += " FROM  vw_ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacao ";
            m_sql += " WHERE(Id_Acomodacao = @Id_Acomodacao) ";
