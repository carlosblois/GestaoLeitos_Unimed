...
{
    public class ConsultarAcomodacaoPorIdEmpresaTO
    {
        string m_sql;
        #region Atributos
        ...
        public ConsultarAcomodacaoPorIdEmpresaTO()
        {
        ...
        #region SQL
        public void ConsultarAcomodacaoPorIdEmpresaTOCommand(int IdEmpresa, string connection, ref List<ConsultarAcomodacaoPorIdEmpresaTO> l_ListAcomodacaoTO)
        {
            ...
            m_sql += " WHERE(A.Id_Empresa = @Id_Empresa) ";
