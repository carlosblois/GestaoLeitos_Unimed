...
{
    public class ConsultarEmpresaPorIdEmpresaTO
    {
        string m_sql;
        #region Atributos
        ...
        public ConsultarEmpresaPorIdEmpresaTO()
        {
        ...
        #region SQL
        public void ConsultarEmpresaPorIdEmpresaTOCommand(int idEmpresa ,string connection, ref List<ConsultarEmpresaPorIdEmpresaTO> l_ListEmpresaTO)
        {
