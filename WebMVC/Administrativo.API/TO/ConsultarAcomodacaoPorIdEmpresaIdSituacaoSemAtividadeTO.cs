...
{
    public class ConsultarAcomodacaoPorIdEmpresaIdSituacaoSemAtividadeTO
    {
        string m_sql;
        #region Atributos
        ...
        public ConsultarAcomodacaoPorIdEmpresaIdSituacaoSemAtividadeTO()
        {
        ...
        #region SQL
        public void ConsultarAcomodacaoPorIdEmpresaIdSituacaoSemAtividadeTOCommand(int IdEmpresa, int IdSituacao, string connection, ref List<ConsultarAcomodacaoPorIdEmpresaIdSituacaoSemAtividadeTO> l_ListAcomodacaoTO)
        {
            ...
            m_sql += "          WHERE(A.Id_Empresa = @Id_Empresa) AND (SA.dt_FimSituacaoAcomodacao IS NULL) AND (TS.Id_TipoSituacaoAcomodacao = @Id_TipoSituacaoAcomodacao) ";
            m_sql += "          AND NOT EXISTS( ";
            m_sql += "                          (SELECT * ";
            m_sql += "                           FROM AtividadeAcomodacao AS AA ";
            m_sql += "                           WHERE AA.Id_SituacaoAcomodacao = SA.Id_SituacaoAcomodacao ";
            m_sql += "                           AND   AA.dt_FimAtividadeAcomodacao  IS NULL) ";
            m_sql += "                          ) ";
