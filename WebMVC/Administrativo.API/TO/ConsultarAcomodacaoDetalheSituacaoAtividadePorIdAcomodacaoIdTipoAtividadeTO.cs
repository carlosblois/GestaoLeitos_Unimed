...
{
    public class ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoIdTipoAtividadeTO
    {
        string m_sql;
        ...
        public ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoIdTipoAtividadeTO()
        {
        ...
        #region SQL
        public void ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoIdTipoAtividadeTOCommand(int IdAcomodacao, int IdTipoAtividade, string connection, ref List<ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacaoTO> l_ListAcomodacaoTO)
        {

            m_sql = " SELECT * ";
            m_sql += " FROM  vw_ConsultarAcomodacaoDetalheSituacaoAtividadePorIdAcomodacao ";
            m_sql += " WHERE(Id_Acomodacao = @Id_Acomodacao AND Id_TipoAtividadeAcomodacao = @IdTipoAtividade) ";

            SqlCommand command = new SqlCommand();
            command.CommandType = CommandType.Text;
            command.CommandText = m_sql;
            command.Parameters.AddWithValue("Id_Acomodacao", IdAcomodacao);
            command.Parameters.AddWithValue("IdTipoAtividade", IdTipoAtividade);
