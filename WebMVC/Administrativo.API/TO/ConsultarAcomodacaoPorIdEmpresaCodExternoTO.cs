...
{
    public class ConsultarAcomodacaoPorIdEmpresaCodExternoTO
    {
        string m_sql;
        #region Atributos
        ...
        public ConsultarAcomodacaoPorIdEmpresaCodExternoTO()
        {
        ...
        #region SQL
        public void ConsultarAcomodacaoPorIdEmpresaCodExternoTOCommand(int IdEmpresa, string CodExterno, string connection, ref List<ConsultarAcomodacaoPorIdEmpresaCodExternoTO> l_ListAcomodacaoTO)
        {
            ...
            m_sql += " WHERE (A.Id_Empresa = @Id_Empresa) AND (A.CodExterno_Acomodacao = @CodExterno_Acomodacao) ";
            ...
            command.Parameters.AddWithValue("CodExterno_Acomodacao", CodExterno);
