...
{
    public class DashboardAtividadeTO
    {
    ...
    public class DashboardAtividade_SituacaoTO
    {
        public string id_TipoAtividadeAcomodacao { get; set; }
        public string nome_TipoAtividadeAcomodacao { get; set; }
        public string id_TipoSituacaoAcomodacao { get; set; }
        ...
        public int ordem { get; set; }
        public string cor { get; set; }
        public List<DashboardAtividade_AcomodacaoTO> Acomodacoes { get; set; }
        
        public DashboardAtividade_SituacaoTO()
        {
            ...
            this.imagem = "";
            this.cor = "";
            this.Acomodacoes = new List<DashboardAtividade_AcomodacaoTO>();

        }
    }

    public class DashboardAtividade_AcomodacaoTO
    {
        public string slA_ATIVIDADE { get; set; }
        public string tempo_Utilizado_Atividade { get; set; }
        public string nome_Acomodacao { get; set; }
        ...
        public DashboardAtividade_AcomodacaoTO()
        {
